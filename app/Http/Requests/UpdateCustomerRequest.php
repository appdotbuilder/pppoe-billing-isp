...
class UpdateCustomerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'pppoe_username' => 'required|string|max:100|unique:customers,pppoe_username,' . $this->route('customer')->id,
    ...
    public function messages(): array
    {
        return [
            ...
            'pppoe_username.unique' => 'This PPPoE username is already taken by another customer.',
